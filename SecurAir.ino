...
void display_logo() {
    ...
    sprite.pushImage(0, 0, 240, 135, SECURAIR_240_135_LOGO);
    sprite.pushSprite(0, 0);
}
...
void setup() {
    Serial.begin(115200);
    Serial.println("SecurAir / www.secura.com start");
    ...
    SecurAirLanguage::select(T, LANGUAGE);
    ...
    WiFiSettings.hostname = "SecurAir-";
    WiFiSettings.language = LANGUAGE;
    WiFiSettings.begin();
    SecurAirLanguage::select(T, WiFiSettings.language);
